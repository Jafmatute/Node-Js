...
const lblEscritorio3 = document.querySelector("#lblEscritorio4");
...
socket.on("estado-actual", (payload) => {
  const [ticke1, ticket2, ticket3, ticket4] = payload;

  if (ticke1) {
    lblTicket1.innerText = "Ticket " + ticke1.numero;
    lblEscritorio1.innerText = ticke1.escritorio;
  }
